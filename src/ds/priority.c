...
static void priority_queue_ensure_capacity(PriorityQueue *queue);
...
PriorityQueueNode *priority_queue_add(PriorityQueue *queue, int priority,
                                      void *data) {
    priority_queue_ensure_capacity(queue);
...
void priority_queue_ensure_capacity(PriorityQueue *queue) {
...
int priority_queue_parent(int index) { return (index - 1) / 2; }

int priority_queue_left_child(int index) { return index * 2 + 1; }

int priority_queue_right_child(int index) { return index * 2 + 2; }

void priority_queue_swap(PriorityQueueNode **heap, int i, int j) {
...
void priority_queue_heapify_up(PriorityQueue *queue, int index) {
...
void priority_queue_heapify_down(PriorityQueue *queue, int index) {
    int minIndex = index;
